...
const WORDS = [
  ...
  // 1) Core personality adjectives
  { id:"IO1_1_freundlich", de:"freundlich", en:"friendly", level:"B1" },
  { id:"IO1_1_nett", de:"nett", en:"nice", level:"B1" },
  { id:"IO1_1_hoeflich", de:"höflich", en:"polite", level:"B1" },
  { id:"IO1_1_unhoeflich", de:"unhöflich", en:"rude / impolite", level:"B1" },
  { id:"IO1_1_schuechtern", de:"schüchtern", en:"shy", level:"B1" },
  { id:"IO1_1_zurueckhaltend", de:"zurückhaltend", en:"reserved", level:"B1" },
  { id:"IO1_1_kontaktfreudig", de:"kontaktfreudig", en:"sociable / outgoing", level:"B1" },
  { id:"IO1_1_gesellig_adj", de:"gesellig", en:"sociable", level:"B1" },
  { id:"IO1_1_ehrlich_adj", de:"ehrlich", en:"honest", level:"B1" },
  { id:"IO1_1_loyal_adj", de:"loyal", en:"loyal", level:"B1" },
  { id:"IO1_1_respektvoll_adj", de:"respektvoll", en:"respectful", level:"B1" },
  { id:"IO1_1_fleissig", de:"fleißig", en:"hardworking / diligent", level:"B1" },
  { id:"IO1_1_organisiert_adj", de:"organisiert", en:"organized", level:"B1" },
  { id:"IO1_1_kreativ_adj", de:"kreativ", en:"creative", level:"B1" },
  { id:"IO1_1_optimistisch", de:"optimistisch", en:"optimistic", level:"B1" },
  { id:"IO1_1_pessimistisch", de:"pessimistisch", en:"pessimistic", level:"B1" },
  { id:"IO1_1_realistisch", de:"realistisch", en:"realistic", level:"B1" },
  { id:"IO1_1_mutig_adj", de:"mutig", en:"brave", level:"B1" },
  { id:"IO1_1_tapfer", de:"tapfer", en:"courageous", level:"B1" },
  { id:"IO1_1_geduldig_adj", de:"geduldig", en:"patient", level:"B1" },
  { id:"IO1_1_ungeduldig", de:"ungeduldig", en:"impatient", level:"B1" },
  { id:"IO1_1_neugierig_adj", de:"neugierig", en:"curious", level:"B1" },
  { id:"IO1_1_ruhig_adj", de:"ruhig", en:"calm / quiet", level:"B1" },
  { id:"IO1_1_unsicher_adj", de:"unsicher", en:"insecure / unsure", level:"B1" },
  { id:"IO1_1_selbstbewusst_adj", de:"selbstbewusst", en:"confident", level:"B1" },
  { id:"IO1_1_arrogant_adj", de:"arrogant", en:"arrogant", level:"B1" },
  { id:"IO1_1_egoistisch_adj", de:"egoistisch", en:"selfish", level:"B1" },
  { id:"IO1_1_froehlich", de:"fröhlich", en:"cheerful / happy", level:"B1" },
  { id:"IO1_1_traurig_adj", de:"traurig", en:"sad", level:"B1" },
  { id:"IO1_1_verantwortungsbewusst_adj", de:"verantwortungsbewusst", en:"responsible", level:"B1" },
  { id:"IO1_1_verantwortungslos", de:"verantwortungslos", en:"irresponsible", level:"B1" },

  // 2) Nouns for Identity
  { id:"IO1_1_persoenlichkeit", de:"Persönlichkeit", en:"personality", level:"B1" },
  { id:"IO1_1_charakter", de:"Charakter", en:"character", level:"B1" },
  { id:"IO1_1_freundschaft", de:"Freundschaft", en:"friendship", level:"B1" },
  { id:"IO1_1_respekt", de:"Respekt", en:"respect", level:"B1" },
  { id:"IO1_1_ehrlichkeit", de:"Ehrlichkeit", en:"honesty", level:"B1" },
  { id:"IO1_1_vertrauen_n", de:"Vertrauen", en:"trust", level:"B1" },
  { id:"IO1_1_staerke", de:"Stärke", en:"strength", level:"B1" },
  { id:"IO1_1_schwaeche", de:"Schwäche", en:"weakness", level:"B1" },
  { id:"IO1_1_mut_n", de:"Mut", en:"courage", level:"B1" },
  { id:"IO1_1_geduld_n", de:"Geduld", en:"patience", level:"B1" },
  { id:"IO1_1_ehrgeiz", de:"Ehrgeiz", en:"ambition", level:"B1" },
  { id:"IO1_1_selbstbewusstsein_n", de:"Selbstbewusstsein", en:"self-confidence", level:"B1" },
  { id:"IO1_1_selbstwertgefuehl", de:"Selbstwertgefühl", en:"self-esteem", level:"B1" },

  // 3) Verbs + phrases (for speaking)
  { id:"IO1_1_sein", de:"sein", en:"to be / be", level:"B1" },
  { id:"IO1_1_haben", de:"haben", en:"to have / have", level:"B1" },
  { id:"IO1_1_moegen", de:"mögen", en:"to like / like", level:"B1" },
  { id:"IO1_1_lieben", de:"lieben", en:"to love / love", level:"B1" },
  { id:"IO1_1_sprechen", de:"sprechen", en:"to speak / speak", level:"B1" },
  { id:"IO1_1_lachen", de:"lachen", en:"to laugh / laugh", level:"B1" },
  { id:"IO1_1_weinen", de:"weinen", en:"to cry / cry", level:"B1" },
  { id:"IO1_1_helfen", de:"helfen", en:"to help / help", level:"B1" },
  { id:"IO1_1_unterstuetzen", de:"unterstützen", en:"to support / support", level:"B1" },
  { id:"IO1_1_respektieren", de:"respektieren", en:"to respect / respect", level:"B1" },
  { id:"IO1_1_schaetzen", de:"schätzen", en:"to appreciate / value / appreciate / value", level:"B1" },
  { id:"IO1_1_verstehen", de:"verstehen", en:"to understand / understand", level:"B1" },
  { id:"IO1_1_vertrauen_v", de:"vertrauen", en:"to trust / trust", level:"B1" },
  { id:"IO1_1_sich_fuehlen", de:"sich fühlen", en:"to feel / feel", level:"B1" },
  { id:"IO1_1_sich_entschuldigen", de:"sich entschuldigen", en:"to apologize / apologize", level:"B1" },
  { id:"IO1_1_verzeihen", de:"verzeihen", en:"to forgive / forgive", level:"B1" },
  { id:"IO1_1_sich_ausdruecken", de:"sich ausdrücken", en:"to express oneself / express oneself", level:"B1" },
  { id:"IO1_1_an_sich_selbst_glauben", de:"an sich selbst glauben", en:"to believe in oneself / believe in oneself", level:"B1" },
  { id:"IO1_1_verantwortung_uebernehmen", de:"Verantwortung übernehmen", en:"to take responsibility / take responsibility", level:"B1" },

  // 4) Connectors + opinion starters
  { id:"IO1_1_ich_finde_dass", de:"Ich finde, dass…", en:"I think that…", level:"B1" },
  { id:"IO1_1_ich_glaube_dass", de:"Ich glaube, dass…", en:"I believe that…", level:"B1" },
  { id:"IO1_1_meiner_meinung_nach", de:"Meiner Meinung nach…", en:"In my opinion…", level:"B1" },
  { id:"IO1_1_weil", de:"weil", en:"because", level:"B1" },
  { id:"IO1_1_aber", de:"aber", en:"but", level:"B1" },
  { id:"IO1_1_und", de:"und", en:"and", level:"B1" },
  { id:"IO1_1_auch", de:"auch", en:"also", level:"B1" },
  { id:"IO1_1_deshalb", de:"deshalb", en:"therefore / that’s why", level:"B1" },
  { id:"IO1_1_trotzdem", de:"trotzdem", en:"nevertheless", level:"B1" },
  { id:"IO1_1_zum_beispiel", de:"zum Beispiel", en:"for example", level:"B1" },
  { id:"IO1_1_oft", de:"oft", en:"often", level:"B1" },
  { id:"IO1_1_manchmal", de:"manchmal", en:"sometimes", level:"B1" },
  { id:"IO1_1_immer", de:"immer", en:"always", level:"B1" },
  { id:"IO1_1_nie", de:"nie", en:"never", level:"B1" },
  { id:"IO1_1_eher", de:"eher", en:"rather / more like", level:"B1" },
  { id:"IO1_1_sehr", de:"sehr", en:"very", level:"B1" },
  { id:"IO1_1_ein_bisschen", de:"ein bisschen", en:"a little", level:"B1" },
  { id:"IO1_1_wenn", de:"wenn", en:"if / when", level:"B1" },

  // 5) Image-description essentials (IO)
  { id:"IO1_1_auf_dem_bild_sehe_ich", de:"Auf dem Bild sehe ich…", en:"In the picture I see…", level:"B1" },
  { id:"IO1_1_im_vordergrund", de:"Im Vordergrund…", en:"In the foreground…", level:"B1" },
  { id:"IO1_1_im_hintergrund", de:"Im Hintergrund…", en:"In the background…", level:"B1" },
  { id:"IO1_1_links", de:"links", en:"left", level:"B1" },
  { id:"IO1_1_rechts", de:"rechts", en:"right", level:"B1" },
  { id:"IO1_1_in_der_mitte", de:"in der Mitte", en:"in the middle", level:"B1" },
  { id:"IO1_1_er_sie_wirkt", de:"Er/Sie wirkt…", en:"He/She seems…", level:"B1" },
  { id:"IO1_1_vielleicht", de:"Vielleicht…", en:"Maybe…", level:"B1" },
  { id:"IO1_1_es_koennte_sein_dass", de:"Es könnte sein, dass…", en:"It could be that…", level:"B1" },
